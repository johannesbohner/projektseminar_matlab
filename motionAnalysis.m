...
fps = 30;
% Framerate, wird nur für die Darstellung im Matlabplot benötigt
...
% SCORE = SCORE(:,1:5); % Weglassen der nicht benötigten Koeffizienten
% COEFF = COEFF(:,1:5); % Weglassen der nicht benötigten Eigenvektoren
% 
...
% for i=1:numEigenvectors
%     %[a,f,p] = calcParameters(SCORE(:,i)); %(alte Lösung)
